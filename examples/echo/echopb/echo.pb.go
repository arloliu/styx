...
func (x *SayRequest) Reset() {
	*x = SayRequest{}
	mi := &file_examples_echo_echo_proto_msgTypes[0]
...
func (*SayRequest) Descriptor() ([]byte, []int) {
	return file_examples_echo_echo_proto_rawDescGZIP(), []int{0}
}
...
func (x *SayResponse) Reset() {
	*x = SayResponse{}
	mi := &file_examples_echo_echo_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*SayResponse) Descriptor() ([]byte, []int) {
	return file_examples_echo_echo_proto_rawDescGZIP(), []int{1}
}
...
const file_examples_echo_echo_proto_rawDesc = "" +
	"\n" +
	"\x18examples/echo/echo.proto\x12\x04echo\"&\n" +
	"\n" +
	"SayRequest\x12\x18\n" +
...
var (
	...
	file_examples_echo_echo_proto_rawDescData []byte
)

func file_examples_echo_echo_proto_rawDescGZIP() []byte {
	file_examples_echo_echo_proto_rawDescOnce.Do(func() {
		file_examples_echo_echo_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_examples_echo_echo_proto_rawDesc), len(file_examples_echo_echo_proto_rawDesc)))
	})
...
func init() { file_examples_echo_echo_proto_init() }
func file_examples_echo_echo_proto_init() {
	if File_examples_echo_echo_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		...
		MessageInfos:      file_examples_echo_echo_proto_msgTypes,
	}.Build()
	File_examples_echo_echo_proto = out.File
	file_examples_echo_echo_proto_goTypes = nil
	file_examples_echo_echo_proto_depIdxs = nil
}
