...
// Transports: []string{"uds"}), registering no services. It completes the
// handshake and data-plane attach over
...
func main() {
	srv := styx.NewPluginServer(styx.PluginServerConfig{Transports: []string{"uds"}})
