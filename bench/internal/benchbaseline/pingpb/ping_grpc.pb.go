...
const (
	Ping_Echo_FullMethodName = "/pingpb.Ping/Echo"
)
...
func (c *pingClient) Echo(ctx context.Context, in *EchoRequest, opts ...grpc.CallOption) (*EchoResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(EchoResponse)
	err := c.cc.Invoke(ctx, Ping_Echo_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedPingServer) Echo(context.Context, *EchoRequest) (*EchoResponse, error) {
...
func _Ping_Echo_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Ping_Echo_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(PingServer).Echo(ctx, req.(*EchoRequest))
	}
...
var Ping_ServiceDesc = grpc.ServiceDesc{
	...
	Metadata: "bench/spike/baseline/pingpb/ping.proto",
}
